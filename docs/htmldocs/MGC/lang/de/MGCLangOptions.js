...
function MGCButtonBarLangOptions()
{
   ...
   Button.Titles["feedback"] = "Feedback an Siemens Digital Industries Software senden";
   Button.Titles["mgc"] = "Website von Siemens Digital Industries Software anzeigen";
   ...
   Button.Text["nexttopic"] = "Nächstes Thema";
   Button.Text["prevtopic"] = "Vorheriges Thema";
   return;
}
...
{
   ODBLabels = {};
   ODBLabels["title"] = "Systemvoreinstellungen für die Dokumentation";
   ODBLabels["close"] = "Optionsdialogfenster schließen";
   ODBLabels["intro"] = "Systemoptionen für die Dokumentation ändern";
