...
function MGCButtonBarLangOptions()
{
   ...
   Button.Titles["feedback"] = "Invia feedback a Siemens Digital Industries Software";
   Button.Titles["mgc"] = "Visualizza il sito web di Siemens Digital Industries Software";
   ...
   Button.Text["nexttopic"] = "Argomento successivo";
   Button.Text["prevtopic"] = "Argomento precedente";
   return;
}
...
{
   ODBLabels = {};
   ODBLabels["title"] = "Preferenze del sistema di documentazione";
   ODBLabels["close"] = "Chiudi la finestra di dialogo Opzioni";
   ODBLabels["intro"] = "Modifica le opzioni del sistema di documentazione";
