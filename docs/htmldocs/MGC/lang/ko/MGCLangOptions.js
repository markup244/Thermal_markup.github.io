...
function MGCButtonBarLangOptions()
{
   ...
   Button.Titles["feedback"] = "Siemens Digital Industries Software에 피드백 보내기";
   Button.Titles["mgc"] = "Siemens Digital Industries Software 웹 사이트 표시";
   ...
   Button.Text["nexttopic"] = "다음 주제";
   Button.Text["prevtopic"] = "이전 주제";
   return;
}
...
{
   ODBLabels = {};
   ODBLabels["title"] = "문서 시스템 환경설정";
   ODBLabels["close"] = "옵션 다이얼로그 닫기";
   ODBLabels["intro"] = "문서 수정 시스템 옵션";
