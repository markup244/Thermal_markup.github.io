...
function MGCButtonBarLangOptions()
{
   ...
   Button.Titles["feedback"] = "Envoyer un retour d’informations à Siemens Digital Industries Software";
   Button.Titles["mgc"] = "Afficher le site Web de Siemens Digital Industries Software";
   ...
   Button.Text["nexttopic"] = "Rubrique suivante";
   Button.Text["prevtopic"] = "Rubrique précédente";
   return;
}
...
{
   ODBLabels = {};
   ODBLabels["title"] = "Préférences du système de documentation";
   ODBLabels["close"] = "Fermer la boîte de dialogue Options";
   ODBLabels["intro"] = "Modifier les options du système de documentation";
